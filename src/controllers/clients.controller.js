...
export const createClient = async (req, res) => {
    try {
        ...
        const foundLeadSources = await Leadsource.find({ name: { $in: leadSource } });
        ...
        const foundStatusProspects = await StatusProspect.find({ name: { $in: prospectStatus } });
        ...
        const foundMediumContacts = await Contact.find({ name: { $in: contactForm } });
